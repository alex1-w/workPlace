...
export const tags = [
    ...
    {
        name: 'Аудио, видео монтаж', link: '/'
    },
    {
        name: 'SEO и оптимизация', link: '/'
    },
    {
        name: 'Бизнес и жизнь', link: '/'
    },
    {
        name: 'Соцсети и реклама', link: '/'
    },
]
                ...
                <div className={styles.textContent}>
                    ...
                    <div className={styles.searchBlock}>
                        ...
                        <div className={styles.tagsBlock}>
                            {/* {tags.map(tag => (
                                <LinkButton link={tag.link} name={tag.name} styleVariant='tagLink' key={tag.name} />
                            ))} */}
                            <Link href='/' >
                                <p>Все категории</p>
                            </Link>
